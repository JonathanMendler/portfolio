...
import AboutImg from "../assets/SquareMulti.svg";

const About = () => {
  return (
    <section className="bg-primary text-teal-800 border-4 border-y-teal-800 px-5 py-32" id="about">
      <div className="container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between">
        <div className="about-info">
          <h2 className="text-4xl font-bold mb-5 border-b-[5px] w-[180px] border-yellow-400 pb-2">About Me</h2>
